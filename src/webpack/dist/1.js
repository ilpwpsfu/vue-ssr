...
var render = function() {
  ...
  return _c("div", [
    _c("span", [_vm._v("CHECK: " + _vm._s(_vm.fetchedData))]),
    _vm._v(" "),
    _c("button", { on: { click: _vm.fetchData } }, [
      _vm._v("Получить с сервера")
    ])
  ])
}
var staticRenderFns = []
...
/* harmony default export */ __webpack_exports__["default"] = ({
  getData: async () => {
    const req = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/prefetchTest');
    return req.data;
  }
});
